...
class Router:
    ...
    def resolve(self, question: str) -> Resolution:
        ...
        # The `intents` default stays at the end of `resolve`, after the event
        # and activity passes below have had their say: a question naming only
        # an event category must come out with the `events` intent, not with
        # the weather fallback this used to hand it.
